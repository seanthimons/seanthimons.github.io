...
ufc_fights %>%
  ...
  ggplot(aes(n, method)) +
  # A Cleveland-style lollipop makes the outcome ranking easier to scan than bars.
  geom_segment(aes(x = 0, xend = n, yend = method), color = "#d6b8b8", linewidth = 0.8) +
  geom_point(color = "#7f1d1d", size = 3.2) +
