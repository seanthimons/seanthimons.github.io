...
region_danger <- lang_status %>%
  filter(!is.na(status_label), !is.na(macroarea)) %>%
...
# UNESCO-inspired palette: safe to extinct
status_cols <- c(
  "safe"                    = "#2D6A4F",
  "vulnerable"              = "#95D5B2",
  "definitely endangered"   = "#F4A261",
  "severely endangered"     = "#E76F51",
  "critically endangered"   = "#9B2226",
  "extinct"                 = "#333333"
)
