...
viewof controls = {
  const container = html`<div style="display: flex; justify-content: center; gap: 10px; margin-bottom: 15px;">
    <button id="zoomIn" style="background: #3a3a5c; color: white; border: none; padding: 8px 16px; border-radius: 6px; cursor: pointer;">➕ Zoom In</button>
    <button id="zoomOut" style="background: #3a3a5c; color: white; border: none; padding: 8px 16px; border-radius: 6px; cursor: pointer;">➖ Zoom Out</button>
    <button id="reset" style="background: #3a3a5c; color: white; border: none; padding: 8px 16px; border-radius: 6px; cursor: pointer;">↺ Reset</button>
