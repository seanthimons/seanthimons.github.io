...
**[CompToxR](https://github.com/seanthimons/ComptoxR)** — R package for accessing EPA's CompTox Chemistry Dashboard API. Enables programmatic retrieval of chemical properties, hazard data, and exposure predictions for risk evaluation workflows.

**[THREAT](https://github.com/seanthimons/THREAT)** — R Shiny application for comparing observational water quality data against toxicological benchmarks. Integrates CompToxR and curated reference datasets to support environmental risk screening.

**[Curation](https://github.com/seanthimons/curation)** — R scripts and workflows for aggregating chemical and toxicological data from public sources into analysis-ready datasets.
